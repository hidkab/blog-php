...
const ERROR_TOO_SHORT = 'Ce champ est très court';
const ERROR_PASSWORD_TOO_SHORT  = 'Le mot de passe doit faire au moins 6 caratères';
const ERROR_PASSWORD_MISMATCH = 'Lot de passe de confirmation est difféfent';
const ERROR_EMAIL_INVALID = 'L\'email n\'est nvalide';
    ...
    <div class="container">
        ...
        <div class="block p-20 form-container">
                ...
                <form action="/auth-register.php", method="POST">
                    ...
                    <div class="form-control">
                        <label for="confirmpassword"></label>Confirmation mot de passe</label>
